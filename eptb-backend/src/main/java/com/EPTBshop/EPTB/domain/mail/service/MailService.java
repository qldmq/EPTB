...
public class MailService {
    ...
    private static int generatedAuthCode;  // 서버에서 생성된 인증번호
    ...
    public ResponseEntity<Map<String, Object>> sendEmail(Map<String, Object> emailData) {
        ...
        generatedAuthCode = secureRandom.nextInt(900000) + 100000;
        ...
        String text = "<html><body>" +
                ...
                "<p><strong>인증번호: " + generatedAuthCode + "</strong></p>" +
                "<p>감사합니다!<br> - EPTB 팀</p>" +
                "</div>" +
        ...
        responseMap.put("message", generatedAuthCode);
        return ResponseEntity.status(HttpStatus.OK).body(responseMap);
    }

    // 인증번호 검증 메서드
    public boolean verifyAuthCode(int inputAuthCode) {
        return generatedAuthCode == inputAuthCode;
    }
}